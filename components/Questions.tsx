...
import { QuestionProp, TagsProps } from '@/utils/interfaces'
  ...
  return (
    <div className="px-5 sm:px-10">
      {questions.map((question: QuestionProp, i: number) => (
        <div
          key={i}
          className="w-full border border-[#212D4A] p-5
        text-xs text-white mt-12 sm:mt-10 rounded-xl space-y-5"
        >
...
const TagsSm: React.FC<TagsProps> = ({ tags }) => {
  return (
    <div className="flex sm:hidden items-center space-x-3 flex-wrap">
